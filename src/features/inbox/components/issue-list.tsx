...
// ⚡ Bolt: Wrap IssueRow in React.memo so that changing the selection index (via keyboard or click)
// only re-renders the newly selected and previously selected rows (O(1)), instead of all rows (O(N)).
